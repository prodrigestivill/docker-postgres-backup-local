group "default" {
	targets = ["debian-latest", "alpine-latest", "debian-13", "debian-12", "debian-11", "debian-10", "debian-9.6", "debian-9.5", "alpine-13", "alpine-12", "alpine-11", "alpine-10", "alpine-9.6", "alpine-9.5"]
}
